...
const SignUp = () => {
  return (
    ...
    <Box className='ContainerSignIn' sx={{ height: '100vh' }} display={'flex'} alignItems={'center'} justifyContent={'center'} gap={5} >
               ...
               <div className='GradientSignIn' style={{ borderRadius:5, boxShadow: '0px 2px 4px white', minWidth: 300, minHeight: 500, paddingTop: 5, paddingBottom:5}}>
                    <header>
                    ...
                    <Box component={'form'} py={2} display={'flex'}  justifyContent={'center'} alignItems={'center'} flexWrap={'wrap'}>
                        ...
                        <Box  rowGap={3} display={'flex'} justifyContent={'center'} alignItems={'center'} flexWrap={'wrap'} flexDirection={'column'}>
                        <TextField color='error' id="outlined-basic" label="Email" variant="filled" placeholder='Email o número de celular' />
                        <TextField color='error' id="outlined-basic" label="Contraseña" variant="filled" placeholder='Contraseña' />

                        <Typography variant='overline' fontSize={10} fullWidth border={'none'} sx={{cursor: 'pointer'}} component={'button'} color='error' >¿Recuperar Contraseña?</Typography>
